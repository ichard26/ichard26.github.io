...
First off, as of writing mypyc has a bug ([mypyc#885]) where its boxing & unboxing code
...
If this scares you, don't fret, it's not impossible to read. First, the globals dict is
